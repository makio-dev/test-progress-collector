...
def create_defect_detail_sheet(wb, team_name, num_records=25):
    ...
    for i in range(num_records):
        ...
        ws.cell(row=row, column=30, value=fix_plan)
        ws.cell(row=row, column=31, value=fix_done)
        ws.cell(row=row, column=33, value=lateral_exists)
        ws.cell(row=row, column=34, value=lateral_target)
        ws.cell(row=row, column=35, value=lateral_plan)
        ws.cell(row=row, column=36, value=lateral_done)
